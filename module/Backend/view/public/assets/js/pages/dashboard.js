...
$(function() {    
    ...
    function trafficSources(element, height) {
        ...
        d3.csv("/backend/assets/demo_data/dashboard/traffic_sources.csv", function (error, data) {
    ...
    function appSalesLines(element, height) {
        ...
        d3.csv("/backend/assets/demo_data/dashboard/app_sales.csv", function(error, data) {
            formatted = data;
            redraw();
        });
    ...
    function salesHeatmap() {
        ...
        d3.csv("/backend/assets/demo_data/dashboard/app_sales_heatmap.csv", function(error, data) {
    ...
    function monthlySalesArea(element, height, color) {
        ...
        d3.json("/backend/assets/demo_data/dashboard/monthly_sales.json", function (error, data) {
    ...
    function bulletChart(element, height) {
        ...
        d3.json("/backend/assets/demo_data/dashboard/bullets.json", function(error, data) {
