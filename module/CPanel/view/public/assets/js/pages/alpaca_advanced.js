...
$(function() {
    ...
    $("#alpaca-option-tree-connector").alpaca({
        "schemaSource": "/backend/assets/demo_data/alpaca/optiontree-custom-schema.json",
        "optionsSource": "/backend/assets/demo_data/alpaca/optiontree-custom-options.json",
        "options": {
            "focus": false
        }
    });
