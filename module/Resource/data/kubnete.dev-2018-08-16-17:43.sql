...
CREATE TABLE `dev_t_document_type_views` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_document_type_views_views` (`template_id`),
  ...
  CONSTRAINT `fk_document_type_views_views` FOREIGN KEY (`template_id`) REFERENCES `sys_t_templates` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-16 17:43:21
